...
Mix_1x4_Stereo_Widget::Mix_1x4_Stereo_Widget() 
{
	...
	for ( ch = 0; ch < CHANNELS; ch++ ) 
    {
        ...
        addChild(createLight<SmallLight<RedLight>>( Vec( x - 4, y + 5 ), module, Mix_1x4_Stereo::LIGHT_MUTE + ch ) );
        //y += 26;
        ...
        addChild(createLight<SmallLight<GreenLight>>( Vec( x + 12, y + 5 ), module, Mix_1x4_Stereo::LIGHT_SOLO + ch ) );
    ...
    for( i = 0; i < GROUPS; i++ )
    {
        ...
        addChild(createLight<SmallLight<RedLight>>( Vec( x2 + 3, y2 + 4 ), module, Mix_1x4_Stereo::LIGHT_GROUP_MUTE + i ) );
...
#define AUX_H 29
        ...
        addChild(createLight<SmallLight<YellowLight>>( Vec( x2 + 1, y2 + 2 ), module, Mix_1x4_Stereo::LIGHT_AUX_PRE + ( i * nAUX ) + 0 ) );
        ...
        addChild(createLight<SmallLight<YellowLight>>( Vec( x2 + 1, y2 + 2 ), module, Mix_1x4_Stereo::LIGHT_AUX_PRE + ( i * nAUX ) + 2 ) );
        ...
        addChild(createLight<SmallLight<YellowLight>>( Vec( x2 + 1, y2 + 2 ), module, Mix_1x4_Stereo::LIGHT_AUX_PRE + ( i * nAUX ) + 1 ) );
        ...
        addChild(createLight<SmallLight<YellowLight>>( Vec( x2 + 1, y2 + 2 ), module, Mix_1x4_Stereo::LIGHT_AUX_PRE + ( i * nAUX ) + 3 ) );
