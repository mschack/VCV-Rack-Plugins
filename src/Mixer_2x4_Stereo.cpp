    ...
    Mix_2x4_Stereo_Widget(Mix_2x4_Stereo *module) : ModuleWidget(module)
{
    ...
    {
        // Left channel inputs
        addChild(Port::create<MyPortInSmall>( Vec( x, y ), Port::INPUT, module, Mix_2x4_Stereo::IN_LEFT + ch ) );

        y += 25;

        // Right channel inputs
        addChild(Port::create<MyPortInSmall>( Vec( x, y ), Port::INPUT, module, Mix_2x4_Stereo::IN_RIGHT + ch ) );

        y += 26;

        // Level knobs
        addParam(ParamWidget::create<Blue2_Small>( Vec( x - 5, y ), module, Mix_2x4_Stereo::PARAM_LEVEL_IN + ch, 0.0, AMP_MAX, 0.0 ) );

        y += 31;

        // Level inputs
        addChild(Port::create<MyPortInSmall>( Vec( x, y ), Port::INPUT, module, Mix_2x4_Stereo::IN_LEVEL + ch ) );

        y += 23;

        // pan knobs
        addParam(ParamWidget::create<Yellow2_Small>( Vec( x - 5, y ), module, Mix_2x4_Stereo::PARAM_PAN_IN + ch, -1.0, 1.0, 0.0 ) );

        y += 31;

        // Pan inputs
        addChild(Port::create<MyPortInSmall>( Vec( x, y ), Port::INPUT, module, Mix_2x4_Stereo::IN_PAN + ch ) );
    ...
    for( i = 0; i < GROUPS; i++ )
    {
        ...
        addParam(ParamWidget::create<Blue2_Small>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_GROUP_LEVEL_IN + i, 0.0, AMP_MAX, 0.0 ) );

        y2 += 32;

        addParam(ParamWidget::create<Yellow2_Small>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_GROUP_PAN_IN + i, -1.0, 1.0, 0.0 ) );
...
#define AUX_H 29
        ...
        x2 = x + 20;
        y2 = ybase + 16;
        addParam(ParamWidget::create<Red1_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_KNOB + (i * nAUX) + 0, 0.0, AMP_MAX, 0.0 ) );
        y2 += AUX_H;
        addParam(ParamWidget::create<Blue3_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_KNOB + (i * nAUX) + 2, 0.0, AMP_MAX, 0.0 ) );

        // aux 2/4
        x2 = x + 38;
        y2 = ybase + 28;

        addParam(ParamWidget::create<Yellow3_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_KNOB + (i * nAUX) + 1, 0.0, AMP_MAX, 0.0 ) );
        y2 += AUX_H;
        addParam(ParamWidget::create<Purp1_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_KNOB + (i * nAUX) + 3, 0.0, AMP_MAX, 0.0 ) );
    ...
    // main mixer knob
    addParam(ParamWidget::create<Blue2_Big>( Vec( 317, 237 ), module, Mix_2x4_Stereo::PARAM_MAIN_LEVEL, 0.0, AMP_MAX, 0.0 ) );
    ...
    addChild(Port::create<MyPortOutSmall>( Vec( 327, 305 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_MAINL ) );
    addChild(Port::create<MyPortOutSmall>( Vec( 359, 335 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_MAINR ) );
...
#define AUX_OUT_H 42
    ...
    addParam(ParamWidget::create<Red1_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_OUT + 0, 0.0, AMP_MAX, 0.0 ) ); y2 += AUX_OUT_H;
    addParam(ParamWidget::create<Yellow3_Med>( Vec( x2, y2  ), module, Mix_2x4_Stereo::PARAM_AUX_OUT + 1, 0.0, AMP_MAX, 0.0 ) ); y2 += AUX_OUT_H;
    addParam(ParamWidget::create<Blue3_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_OUT + 2, 0.0, AMP_MAX, 0.0 ) ); y2 += AUX_OUT_H;
    addParam(ParamWidget::create<Purp1_Med>( Vec( x2, y2 ), module, Mix_2x4_Stereo::PARAM_AUX_OUT + 3, 0.0, AMP_MAX, 0.0 ) );

    x2 = 326;
    y2 = 45;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXL ) ); y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXL + 1 ) );  y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXL + 2 ) ); y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXL + 3 ) );

    x2 = 355;
    y2 = 45;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXR ) ); y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXR + 1 ) ); y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXR + 2 ) ); y2 += AUX_OUT_H;
    addChild(Port::create<MyPortOutSmall>( Vec( x2, y2 ), Port::OUTPUT, module, Mix_2x4_Stereo::OUT_AUXR + 3 ) );
...
Model *modelMix_2x4_Stereo_Widget = Model::create<Mix_2x4_Stereo, Mix_2x4_Stereo_Widget>( "mscHack", "Mix_2x4_Stereo", "MIXER 2x4 Stereo/Mono", MIXER_TAG, EQUALIZER_TAG, DUAL_TAG, PANNING_TAG, AMPLIFIER_TAG, MULTIPLE_TAG );
